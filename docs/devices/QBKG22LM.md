...
The possible values are :  `single_left`, `double_left`, `release_left`, `hold_left`, `hold_release_left`, `single_right`, `double_right`, `release_right`, `hold_right`, `hold_release_right`, `single_both`, `release_both`, `hold_both`, `hold_release_both`.
